...
class FM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.frequency = frequency = 89700000

        ##################################################
        # Blocks
        ##################################################

        self._frequency_range = qtgui.Range(88000000, 108000000, 50000, 89700000, 200)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 80e3, 10e3, window.WIN_HAMMING, 6.76))
